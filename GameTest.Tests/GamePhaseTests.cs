...
public class GamePhaseTests
{
    ...
    public void Constructor_DTO()
    {
        ...
        gamePhase.SetTargetPlayers(new List<Player>() {p2});
    ...
    public void Constructor_Copy()
    {
        ...
        originalGamePhase.SetTargetPlayers(new List<Player>() { p1, p2});
        ...
        Assert.NotNull(newGamePhase.TargetPlayers);
        Assert.Equal(2, newGamePhase.TargetPlayers.Count);
        Assert.Contains(p1, newGamePhase.TargetPlayers);
        Assert.Contains(p2, newGamePhase.TargetPlayers);
    ...
    public void SetStateToReturnTo_StateNullBefore()
    {
        ...
        gamePhase.SetTargetPlayers(new List<Player>());
    ...
    private TestGameBoard CreateBoardForSelectTargetTesting(GameStates startingState, GameStates returnState)
    {
        ...
        board.GetGameState().Phase.SetTargetPlayers(new List<Player>() { board.GetBluePlayer(), orangePlayer });
    ...
    public void SelectTargetPlayer_OneListed()
    {
        var board = TestHelpers.CreateOriginalTestBoard();
        board.GetGameState().Phase = new GamePhase(GameStates.PlaceRobber, board.GetRedPlayer(), board.GetBluePlayer());
        board.GetGameState().Phase.SetTargetPlayers(new List<Player>() {board.GetRedPlayer()});
    ...
    public void SelectTargetPlayer_OneSelected()
    {
        var board = TestHelpers.CreateOriginalTestBoard();
        board.GetGameState().Phase = new GamePhase(GameStates.PlaceRobber, board.GetRedPlayer(), board.GetBluePlayer());
        board.GetGameState().Phase.SetTargetPlayers(new List<Player>() {board.GetBluePlayer(), board.GetRedPlayer()});
    ...
    [Fact]
    public void MoveToPreviousPhase_PlaceFirstRoadToPlaceFirstSettlement_SamePlayer()
    {
        var board = TestHelpers.CreateOriginalTestBoard();
        var gs = board.GetGameState();
    ...
    [Fact]
    public void MoveToPreviousPhase_PlaceFirstSettlement_InvalidAsStartingPlayer()
    {
        var board = TestHelpers.CreateOriginalTestBoard();
        var gs = board.GetGameState();
    ...
    [Fact]
    public void MoveToPreviousPhase_PlaceFirstSettlementToPlaceFirstRoad_PreviousPlayer()
    {
        var board = TestHelpers.CreateOriginalTestBoard();
        var gs = board.GetGameState();
    ...
    [Fact]
    public void MoveToPreviousPhase_PlaceSecondSettlementToPlaceFirstRoad_SamePlayer()
    {
        var board = TestHelpers.CreateOriginalTestBoard();
        var gs = board.GetGameState();
    ...
    [Fact]
    public void MoveToPreviousPhase_PlaceSecondSettlementToPlaceSecondRoad_PreviousPlayer()
    {
        var board = TestHelpers.CreateOriginalTestBoard();
        var gs = board.GetGameState();
    ...
    [Fact]
    public void MoveToPreviousPhase_PlaceSecondRoadToPlaceSecondSettlement_SamePlayer()
    {
        var board = TestHelpers.CreateOriginalTestBoard();
        var gs = board.GetGameState();
    ...
    [Fact]
    public void MoveToPreviousPhase_RollOrUseDevCardToPlaceSecondRoad_SamePlayer()
    {
        var board = TestHelpers.CreateOriginalTestBoard();
        var gs = board.GetGameState();
    ...
    // TODO: Need to finish MoveToPreviousPhase implementation
    // [Fact]
    // public void MoveToPreviousPhase_TODO_ADD_REMAINING()
    // {
    //     Assert.True(false);
    // }
}